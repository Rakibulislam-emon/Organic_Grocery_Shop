import banner from '../../assets/banner/asset 44.jpeg'

export default function DiscountBanner() {
    return (
        <main className="max-w-screen-2xl mx-auto px-4">
            <div
                className="relative  flex flex-col lg:flex-row items-center justify-evenly lg:h-[250px] md:h-[400px] h-[400px] bg-cover bg-center rounded-lg shadow-lg"
                style={{
